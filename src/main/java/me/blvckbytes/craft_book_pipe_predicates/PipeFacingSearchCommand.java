...
public class PipeFacingSearchCommand implements CommandExecutor, TabCompleter {

  private final PipePredicateCommand predicateCommandExecutor;
  private final Command predicateCommand;

  public PipeFacingSearchCommand(
  ...
  private String[] extendArgs(String[] args) {
    ...
    extendedArgs[0] = CommandAction.matcher.getNormalizedName(CommandAction.FACING_SEARCH);
